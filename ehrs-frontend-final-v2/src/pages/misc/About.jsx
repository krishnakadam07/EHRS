...
<<<<<<< HEAD
import { FiHeart, FiShield, FiLink, FiArrowRight, FiActivity, FiUsers, FiGlobe } from 'react-icons/fi';
=======
...
<<<<<<< HEAD
   ...
   return (
       <div className="min-h-screen bg-slate-50 flex flex-col font-sans overflow-hidden relative selection:bg-primary/30">
          ...
          {/* 🌟 NEW INTERACTIVE NAVBAR (From Home.jsx) */}
          <motion.nav
              initial={{ y: -100 }}
              animate={{ y: 0 }}
